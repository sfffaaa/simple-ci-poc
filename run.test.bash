...
SET_DATETIME=${DATETIME} bash new.chain.test.bash --chain peaq-dev --test "test_multisig"
SET_DATETIME=${DATETIME} bash fork.chain.test.bash --chain peaq-dev --test "test_multisig"
